namespace Repository
{
    ...
    public class StudentRepository : BaseRepository, IStudentRepository
    {
        ...
        private const string UpdateGradeChangeRequestProcedure = "spUpdateGradeChangeRequest";
        private const string UpdateGradingOptionProcedure = "spUpdateGradingOption";
        ...
        public void InsertStudent(Student student, ref List<string> errors)
        {
            ...
            try
            {
                ...
                adapter.SelectCommand.Parameters.Add(new SqlParameter("@age", SqlDbType.Int));
                ...
                adapter.SelectCommand.Parameters["@age"].Value = student.Age;
                ...
                student = new Student
                              {
                                  ...
                                  Age = Convert.ToInt32(dataSet.Tables[0].Rows[0]["age"].ToString())
                              };
        ...
        public void UpdateGradeChangeRequest(string studentId, int scheduleId, bool requestChange, ref List<string> errors)
        {
            ...
            try
            {
                var adapter = new SqlDataAdapter(UpdateGradeChangeRequestProcedure, conn)
                {
                    SelectCommand =
                    {
                        CommandType
                ...
                adapter.SelectCommand.Parameters.Add(new SqlParameter("@student_id", SqlDbType.VarChar, 20));
                adapter.SelectCommand.Parameters.Add(new SqlParameter("@schedule_id", SqlDbType.Int));
                adapter.SelectCommand.Parameters.Add(new SqlParameter("@grade_change", SqlDbType.Bit));

                adapter.SelectCommand.Parameters["@student_id"].Value = studentId;
                adapter.SelectCommand.Parameters["@schedule_id"].Value = scheduleId;
                adapter.SelectCommand.Parameters["@grade_change"].Value = requestChange;
        ...
        public void UpdateGradingOption(string studentId, int scheduleId, string gradingOpt, ref List<string> errors)
        {
            ...
            try
            {
                var adapter = new SqlDataAdapter(UpdateGradingOptionProcedure, conn)
                {
                    SelectCommand =
                    {
                        CommandType
                ...
                adapter.SelectCommand.Parameters.Add(new SqlParameter("@student_id", SqlDbType.VarChar, 20));
                adapter.SelectCommand.Parameters.Add(new SqlParameter("@schedule_id", SqlDbType.Int));
                adapter.SelectCommand.Parameters.Add(new SqlParameter("@grading_opt", SqlDbType.VarChar, 20));

                adapter.SelectCommand.Parameters["@student_id"].Value = studentId;
                adapter.SelectCommand.Parameters["@schedule_id"].Value = scheduleId;
                adapter.SelectCommand.Parameters["@grading_opt"].Value = gradingOpt;
