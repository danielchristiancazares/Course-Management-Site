namespace Service
{
    ...
    public class StudentService
    {
        ...
        public void RequestGradeChange(string studentId, int scheduleId, bool requestChange, ref List<string> errors)
        {
            if (string.IsNullOrEmpty(studentId) || scheduleId < 0)
            {
                errors.Add("Invalid student id or schedule id");
        ...
        public void SwitchGradingOption(string studentId, int scheduleId, string gradingOpt, ref List<string> errors)
        {
            if (string.IsNullOrEmpty(studentId) || scheduleId < 0)
            {
                errors.Add("Invalid student id or schedule id");
